...
from gui.rawgl_controller import RawGLController
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self._create_rawgl_panel() # ADDED: Panel for RawGL controls
    ...
    def _create_rawgl_panel(self):
        """Creates and adds the RawGL controller panel."""
        self.rawgl_panel = RawGLController()
        self.left_panel_layout.addWidget(self.rawgl_panel)
